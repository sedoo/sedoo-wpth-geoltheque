...
<div role="description">
    <section role="tab-block">
        ...
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li role="presentation"><a href="#arret-a-proximite" aria-controls="arret-a-proximite" role="tab" data-toggle="tab" onclick="mapProxy()">Arrêt(s) à proximité &nbsp;<i class="icon-right-dir"></i></a></li>
