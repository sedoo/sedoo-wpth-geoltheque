...
?>
    <footer>
        ...
        <section role="links">
            ...
            <ul>
                <li>
                    <a href="http://pedagogie.ac-toulouse.fr/svt/serveur/sig/index.htm" title="Accéder aux ressources par thèmes d'activités et par outils logiciels"><img width="50px" src="<?php echo get_bloginfo('template_directory') ?>/images/logoSIGs.jpg" alt="">SIGthèque</a>
                </li>
                ...
                <li><a href="http://eduscol.education.fr/svt/enseigner/ressources-et-usages-numeriques.html" title="Portail national de ressources éduscol, Sciences de la Vie et de la Terre"><img width="50px" src="<?php echo get_bloginfo('template_directory') ?>/images/educ-nat1.gif" alt="">Lithothèques</a></li>
            </ul>
        </section>
        <section></section>
    </footer>
