...
?>
   <header>
       <div role="banner" style="background-image: url(<?php echo $thumbnailUrl; ?>)">
            <h1>Fiche de sortie : <?php echo $MasterFicheTitle;?>
 ...
 <!-- ********************* THEMES ******************-->
    ...
    <main>
       <?php
        /********************* DESCRIPTION + ANNEXES DE L'ARRET  ******************/
//                get_template_part( 'template-parts/content-description-arretsortie');
        ?>
        <?php
        ...
        ?>
        <h1>
        <a href="<?php echo $MasterFicheUrl;?>" title="Revenir à la fiche de sortie">Fiche de sortie : <?php echo $MasterFicheTitle;?></a> // Arrêt : <?php the_title(); ?>
        </h1>
        <h2>Données issues du terrain</h2>
        <div role="description">
            <section role="tab-block">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li role="presentation"><a href="#arret-a-proximite" aria-controls="arret-a-proximite" role="tab" data-toggle="tab" onclick="mapArrets()">Arrêt(s) à proximité &nbsp;<i class="icon-right-dir"></i></a></li>
                </ul>
                    ...
                    <article role="tabpanel" class="tab-pane fade" id="arret-a-proximite">
                      <section role="resultat-recherche" class="simple">
                        ...
                        if( get_field('arret_a_proximite-description_sortie-edugeol') ) 
                        {
                            ...
                            echo "<h2>Liste des arrets à proximité</h2>";
                            $i=0;
                            $fichearret = array();
            ...
            <h2 role="titre-description">Éléments d'interprétation / Activités</h2>
            <section role="tab-block">
            ...
            <!-- ********************* ANNEXES ******************-->
            <h2 role="titre-description">ANNEXES</h2>
            <section role="tab-block" >
